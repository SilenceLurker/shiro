...
public class ShiroFilterFactoryBean implements FactoryBean {
    ...
    public ShiroFilterFactoryBean() {
        if (this.manager == null) {
            this.manager = new ShiroFilterBeanManager();
        }
    }
    ...
    public void setManager(ShiroFilterBeanManager manager) {
        this.manager.mergeWith(manager);
    }
    ...
    public void setFilterChainDefinitions(String definitions) {
        ...
        manager.setFilterChainDefinitionMap(section);
    }
    ...
    public Object getObject() throws Exception {
        if (manager.getInstance() == null) {
            manager.setInstance(createInstance());
        }
    ...
    protected FilterChainManager createFilterChainManager() {
        ...
        Map<String, Filter> filters = this.manager.getFilters();
        ...
        manager.setGlobalFilters(this.manager.getGlobalFilters());

        //build up the chains:
        Map<String, String> chains = this.manager.getFilterChainDefinitionMap();
    ...
    protected AbstractShiroFilter createInstance() throws Exception {
        ...
        SecurityManager securityManager = this.manager.getSecurityManager();
        ...
        return new SpringShiroFilter((WebSecurityManager) securityManager, chainResolver,
                // manager.getShiroFilterConfiguration());
                this.manager.getShiroFilterConfiguration());
    }
    ...
    public SecurityManager getSecurityManager() {
        return this.manager.getSecurityManager();
    }
    ...
    public void setSecurityManager(SecurityManager securityManager) {
        this.manager.setSecurityManager(securityManager);
    }
    ...
    public ShiroFilterConfiguration getShiroFilterConfiguration() {
        return this.manager.getShiroFilterConfiguration();
    }
    ...
    public void setShiroFilterConfiguration(ShiroFilterConfiguration filterConfiguration) {
        this.manager.setShiroFilterConfiguration(filterConfiguration);
    }
    ...
    public String getLoginUrl() {
        return this.manager.getLoginUrl();
    }
    ...
    public void setLoginUrl(String loginUrl) {
        this.manager.setLoginUrl(loginUrl);
    }
    ...
    public String getSuccessUrl() {
        return this.manager.getSuccessUrl();
    }
    ...
    public void setSuccessUrl(String successUrl) {
        this.manager.setSuccessUrl(successUrl);
    }
    ...
    public String getUnauthorizedUrl() {
        return this.manager.getUnauthorizedUrl();
    }
    ...
    public void setUnauthorizedUrl(String unauthorizedUrl) {
        this.manager.setUnauthorizedUrl(unauthorizedUrl);
    }
    ...
    public Map<String, Filter> getFilters() {
        return this.manager.getFilters();
    }
    ...
    public void setFilterChainDefinitionMap(Map<String, String> filterChainDefinitionMap) {
        this.manager.setFilterChainDefinitionMap(filterChainDefinitionMap);
    }
